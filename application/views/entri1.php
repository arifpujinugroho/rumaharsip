...
<div class="form-group">
	...
	<div class="col-md-8">
	<input type="file" id="file" name="file" accept=".doc,.docx,.pdf,.xls,.xlsx,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document,application/pdf">
