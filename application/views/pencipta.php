...
<nav class="navbar navbar-inverse navbar-submenu">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="<?php echo site_url('/admin/penc'); ?>">Data Pembuat Arsip</a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="module-submenu">
      <ul class="nav navbar-nav navbar-right">
	       ...
	       <li><a href="#" data-toggle="modal" data-target="#addpenc"><i class="glyphicon glyphicon-plus"></i> Input Data Baru</a></li>
        <?php endif; ?>
      </ul>
    </div><!-- /.navbar-collapse -->
  </div><!-- /.container-fluid -->
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Tambah Pembuat Arsip</h4>
      </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Edit Pembuat Arsip</h4>
      </div>
	  <div class="modal-body">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Delete Pembuat Arsip</h4>
      </div>
	  <div class="modal-body">
