...
<head>
    ...
    <title>ARSIP DATA DEB SV UGM <?php if(isset($title)) echo " - ".$title ?></title>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a style="padding-top: 13px;" class="navbar-brand" href="<?php echo site_url('/home'); ?>"><img src="<?php echo base_url('/logo/kecil-logo.png'); ?>" alt="ARSIP DATA" height="35"></a>
            </div>
                ...
                <ul class="nav navbar-nav">
					<?php
						if(isset($_SESSION['akses_modul']['entridata']) && $_SESSION['akses_modul']['entridata']=='on') {
                            echo '<li><a href="'.site_url('/admin/entr').'"><i class="glyphicon glyphicon-glass"></i> Input Arsip Baru</a></li>';
						}
						if(isset($_SESSION['akses_modul']['sirkulasi']) && $_SESSION['akses_modul']['sirkulasi']=='on') {
                            echo '<li><a href="'.site_url('/sirkulasi').'"><i class="glyphicon glyphicon-signal"></i> Pinjam-meminjam</a></li>';
						}
						if($_SESSION['menu_master']) 
						{
							echo '<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
							<i class="glyphicon glyphicon-th-large"></i> Daftar Menu Arsip <span class="caret"></span></a><ul class="dropdown-menu">';
							...
							if(isset($_SESSION['akses_modul']['pencipta']) && $_SESSION['akses_modul']['pencipta']=='on') {
								echo "<li><a href=\"".site_url('admin/penc')."\"><i class=\"glyphicon glyphicon-home\"></i> Pembuat arsip</a></li>";
							}
